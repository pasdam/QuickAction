...
public class CustomPopupWindow {
	 ...
	 */
	public void showDropDown(int style) {
		showDropDown(0, 0, style);
	}
	 ...
	 */
	public void showDropDown(int xOffset, int yOffset, int style) {
		preShow();
		
		switch (style) {
		case QuickAction.STYLE_SLIDE:
			window.setAnimationStyle(R.style.Animations_PopDownMenu_Left);
			break;
		case QuickAction.STYLE_POP_DOWN:
