package com.pasdam.quickaction;
...
public class QuickAction extends CustomPopupWindow {
	...
	public static final int STYLE_POP_DOWN = 1;
	 ...
	 * @param style style of the popup (STYLE_SLIDE, STYLE_POP_DOWN)
	 */
	public QuickAction(View anchor, int style) {
		super(anchor);
		...
		switch (this.style) {
		case STYLE_SLIDE:
			this.root		= (ViewGroup) this.inflater.inflate(R.layout.quickaction_slider, null);
			
			this.mTrackAnim 	= AnimationUtils.loadAnimation(anchor.getContext(), R.anim.quickaction_rail);
		...
		case STYLE_POP_DOWN:
			this.root		= (ViewGroup) this.inflater.inflate(R.layout.quickaction_popdown, null);
			
			this.mTrackAnim = null;
			
			this.scroller = (ScrollView) root.findViewById(R.id.scroller);
	...
	private View getActionItem(String title, Drawable icon, OnClickListener listener) {
		...
		switch (this.style) {
		case STYLE_SLIDE:
			container	= (LinearLayout) inflater.inflate(R.layout.quickaction_slider_item, null);
			break;
		case STYLE_POP_DOWN:
			container	= (LinearLayout) inflater.inflate(R.layout.quickaction_popdown_item, null);
			break;
		}
